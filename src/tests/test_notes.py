...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"title": "foo", "description": "bar", "id": 2},
        {"title": "foo", "description": "bar", "id": 3},
        {"title": "foo", "description": "bar", "id": 4},
        {"title": "foo", "description": "bar", "id": 5},
        {"title": "foo", "description": "bar", "id": 6}

    ],

)
def test_remove_all_notes(test_app, monkeypatch, payload):
    test_data = payload
    ...
    response = test_app.delete("/notes/")
